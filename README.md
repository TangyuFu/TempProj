...
以 UnityGameFramework <https://github.com/EllanJiang/GameFramework> 为基础，添加基本开发模块。
...
1. **内置数据 (BuiltinData)** - 提供初始化数据及加载场景等功能。

2. **脚本 (Script)** - 提供热更新脚本语言的启动、关闭等功能。

3. **摄像机 (Camera)** - 提供摄像机配置与相关操作等功能。

## 安装

1. clone <> 项目远程地址。
2. Assets/R/EffectProj ，clone <> 特效远程地址。
3. Assets/R/ModelProj ，clone <> 模型远程地址。
4. Assets/R/TableProj ，clone <> 数据表远程地址。
5. Assets/R/UIProj ，clone <> UI 远程地址。
