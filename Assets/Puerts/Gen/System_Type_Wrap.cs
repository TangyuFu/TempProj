...
namespace PuertsStaticWrap
{
    public static class System_Type_Wrap
    {
            ...
            try
            {
                ...
                if (paramLen == 6)
                {
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.String, null, false, false)
                        && argHelper1.IsMatch(Puerts.JsValueType.Number, null, false, false)
                        && argHelper2.IsMatch(Puerts.JsValueType.Number, null, false, false)
                        && argHelper3.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.NativeObject, typeof(System.Reflection.Binder), false, false)
                        && argHelper4.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.NativeObject, typeof(System.Type[]), false, false)
                        && argHelper5.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.NativeObject, typeof(System.Reflection.ParameterModifier[]), false, false))
                    {
                ...
                if (paramLen == 7)
                {
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.String, null, false, false)
                        ...
                        && argHelper5.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.NativeObject, typeof(System.Type[]), false, false)
                        && argHelper6.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.NativeObject, typeof(System.Reflection.ParameterModifier[]), false, false))
                    {
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void F_MakeGenericSignatureType(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                ...
                if (paramLen >= 1)
                {
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.NativeObject, typeof(System.Type), false, false)
                        && argHelper1.IsMatchParams(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.NativeObject, typeof(System.Type), 1, paramLen))
                    {
                        
                        var Arg0 = argHelper0.Get<System.Type>(false);
                        var Arg1 = argHelper1.GetParams<System.Type>(info, 1, paramLen);
                        // var result = System.Type.MakeGenericSignatureType(Arg0,Arg1);
                ...
                if (paramLen == 1)
                {
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.NativeObject, typeof(System.Type), false, false))
                    {
                        ...
                        var Arg0 = argHelper0.Get<System.Type>(false);
                        // var result = System.Type.MakeGenericSignatureType(Arg0);
                ...
                Puerts.PuertsDLL.ThrowException(isolate, "invalid arguments to MakeGenericSignatureType");
            }
            catch (Exception e)
            {
                Puerts.PuertsDLL.ThrowException(isolate, "c# exception:" + e.Message + ",stack:" + e.StackTrace);
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void G_IsCollectible(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as System.Type;
                // var result = obj.IsCollectible;
                // Puerts.PuertsDLL.ReturnBoolean(isolate, info, result);
            }
            catch (Exception e)
            {
        ...
        public static Puerts.TypeRegisterInfo GetRegisterInfo()
        {
            return new Puerts.TypeRegisterInfo()
            {
                ...
                Methods = new System.Collections.Generic.Dictionary<Puerts.MethodKey, Puerts.V8FunctionCallback>()
                {
                    ...
                    { new Puerts.MethodKey {Name = "MakeGenericSignatureType", IsStatic = true}, F_MakeGenericSignatureType },
                ...
                Properties = new System.Collections.Generic.Dictionary<string, Puerts.PropertyRegisterInfo>()
                {
                    ...
                    {"IsCollectible", new Puerts.PropertyRegisterInfo(){ IsStatic = false, Getter = G_IsCollectible, Setter = null} },
