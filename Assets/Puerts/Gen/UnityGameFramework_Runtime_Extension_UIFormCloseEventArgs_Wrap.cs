...
{
    public static class UnityGameFramework_Runtime_Extension_UIFormCloseEventArgs_Wrap
    {
            ...
            try
            {
                ...
                
                {
                    ...
                    
                    {
                        ...
                        var result = new UnityGameFramework.Runtime.Extension.UIFormCloseEventArgs();
                        
                        
                        return Puerts.Utils.GetObjectPtr((int)data, typeof(UnityGameFramework.Runtime.Extension.UIFormCloseEventArgs), result);
                    }
            ...
            try
            {
                ...
                
                {
                    ...
                    
                    {
                        ...
                        var result = UnityGameFramework.Runtime.Extension.UIFormCloseEventArgs.Create(Arg0,Arg1,Arg2,Arg3);
        ...
        private static void M_Clear(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityGameFramework.Runtime.Extension.UIFormCloseEventArgs;
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void G_IsShutdown(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityGameFramework.Runtime.Extension.UIFormCloseEventArgs;
                var result = obj.IsShutdown;
        ...
        private static void G_EventId(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                ...
                var result = UnityGameFramework.Runtime.Extension.UIFormCloseEventArgs.EventId;
                Puerts.PuertsDLL.ReturnNumber(isolate, info, result);
            }
            catch (Exception e)
            {
        ...
        public static Puerts.TypeRegisterInfo GetRegisterInfo()
        {
            return new Puerts.TypeRegisterInfo()
            {
                ...
                Properties = new System.Collections.Generic.Dictionary<string, Puerts.PropertyRegisterInfo>()
                {
                    ...
                    {"IsShutdown", new Puerts.PropertyRegisterInfo(){ IsStatic = false, Getter = G_IsShutdown, Setter = null} },
