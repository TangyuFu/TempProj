...
{
    public static class UnityGameFramework_Runtime_SettingComponent_Wrap
    {
            ...
            try
            {
                ...
                
                {
                    ...
                    
                    {
                        ...
                        var result = new UnityGameFramework.Runtime.SettingComponent();
                        
                        
                        return Puerts.Utils.GetObjectPtr((int)data, typeof(UnityGameFramework.Runtime.SettingComponent), result);
                    }
        ...
        private static void M_Save(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityGameFramework.Runtime.SettingComponent;
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void M_GetAllSettingNames(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityGameFramework.Runtime.SettingComponent;
                ...
                if (paramLen == 0)
                {
                    ...
                    
                    {
                        ...
                        var result = obj.GetAllSettingNames();
                ...
                Puerts.PuertsDLL.ThrowException(isolate, "invalid arguments to GetAllSettingNames");
            }
            catch (Exception e)
            {
                Puerts.PuertsDLL.ThrowException(isolate, "c# exception:" + e.Message + ",stack:" + e.StackTrace);
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void M_HasSetting(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityGameFramework.Runtime.SettingComponent;
                ...
                
                {
                    ...
                    
                    {
                        ...
                        var result = obj.HasSetting(Arg0);
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void M_RemoveSetting(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityGameFramework.Runtime.SettingComponent;
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void M_RemoveAllSettings(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityGameFramework.Runtime.SettingComponent;
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void M_SetBool(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityGameFramework.Runtime.SettingComponent;
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void M_SetString(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityGameFramework.Runtime.SettingComponent;
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void M_GetObject(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityGameFramework.Runtime.SettingComponent;
                ...
                if (paramLen == 2)
                {
                        ...
                        && argHelper1.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.String, null, false, false))
                    {
                        ...
                        var Arg1 = argHelper1.GetString(false);
                        var result = obj.GetObject(Arg0,Arg1);
                ...
                if (paramLen == 3)
                {
                        ...
                        && argHelper2.IsMatch(Puerts.JsValueType.Any, typeof(System.Object), false, false))
                    {
                        ...
                        var result = obj.GetObject(Arg0,Arg1,Arg2);
                ...
                Puerts.PuertsDLL.ThrowException(isolate, "invalid arguments to GetObject");
            }
            catch (Exception e)
            {
                Puerts.PuertsDLL.ThrowException(isolate, "c# exception:" + e.Message + ",stack:" + e.StackTrace);
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void M_SetObject(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityGameFramework.Runtime.SettingComponent;
        ...
        public static Puerts.TypeRegisterInfo GetRegisterInfo()
        {
            return new Puerts.TypeRegisterInfo()
            {
                ...
                Methods = new System.Collections.Generic.Dictionary<Puerts.MethodKey, Puerts.V8FunctionCallback>()
                {
                    ...
                    { new Puerts.MethodKey {Name = "Save", IsStatic = false}, M_Save },
                    
                    { new Puerts.MethodKey {Name = "GetAllSettingNames", IsStatic = false}, M_GetAllSettingNames },
                    
                    { new Puerts.MethodKey {Name = "HasSetting", IsStatic = false}, M_HasSetting },
                    
                    { new Puerts.MethodKey {Name = "RemoveSetting", IsStatic = false}, M_RemoveSetting },
                    
                    { new Puerts.MethodKey {Name = "RemoveAllSettings", IsStatic = false}, M_RemoveAllSettings },
                    ...
                    { new Puerts.MethodKey {Name = "SetString", IsStatic = false}, M_SetString },
                    
                    { new Puerts.MethodKey {Name = "GetObject", IsStatic = false}, M_GetObject },
                    
                    { new Puerts.MethodKey {Name = "SetObject", IsStatic = false}, M_SetObject },
