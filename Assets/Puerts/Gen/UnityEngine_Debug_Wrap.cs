            ...
            try
            {
                ...
                if (paramLen >= 1)
                {
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.String, null, false, false)
                        && argHelper1.IsMatchParams(Puerts.JsValueType.Any, typeof(System.Object), 1, paramLen))
                    {
                ...
                if (paramLen == 1)
                {
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.String, null, false, false))
                    {
                        ...
                        var Arg0 = argHelper0.GetString(false);
                        UnityEngine.Debug.LogFormat(Arg0);
                ...
                if (paramLen >= 2)
                {
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.NativeObject, typeof(UnityEngine.Object), false, false)
                        ...
                        && argHelper2.IsMatchParams(Puerts.JsValueType.Any, typeof(System.Object), 2, paramLen))
                    {
                ...
                if (paramLen >= 4)
                {
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.Number, null, false, false)
                        ...
                        && argHelper4.IsMatchParams(Puerts.JsValueType.Any, typeof(System.Object), 4, paramLen))
                    {
                ...
                if (paramLen == 4)
                {
                        ...
                        && argHelper3.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.String, null, false, false))
                    {
                        ...
                        var Arg2 = argHelper2.Get<UnityEngine.Object>(false);
                        var Arg3 = argHelper3.GetString(false);
                        UnityEngine.Debug.LogFormat(Arg0,Arg1,Arg2,Arg3);
            ...
            try
            {
                ...
                if (paramLen == 1)
                {
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.String, null, false, false))
                    {
                        ...
                        var Arg0 = argHelper0.GetString(false);
                        UnityEngine.Debug.LogErrorFormat(Arg0);
            ...
            try
            {
                ...
                if (paramLen == 1)
                {
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.String, null, false, false))
                    {
                        ...
                        var Arg0 = argHelper0.GetString(false);
                        UnityEngine.Debug.LogWarningFormat(Arg0);
            ...
            try
            {
                ...
                if (paramLen == 2)
                {
                        ...
                        && argHelper1.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.String, null, false, false))
                    {
                        ...
                        var Arg0 = argHelper0.GetBoolean(false);
                        var Arg1 = argHelper1.GetString(false);
                        UnityEngine.Debug.AssertFormat(Arg0,Arg1);
                ...
                if (paramLen >= 3)
                {
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.Boolean, null, false, false)
                        ...
                        && argHelper3.IsMatchParams(Puerts.JsValueType.Any, typeof(System.Object), 3, paramLen))
                    {
            ...
            try
            {
                ...
                if (paramLen == 1)
                {
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.String, null, false, false))
                    {
                        ...
                        var Arg0 = argHelper0.GetString(false);
                        UnityEngine.Debug.LogAssertionFormat(Arg0);
