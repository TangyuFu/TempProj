...
{
    public static class UnityGameFramework_Runtime_DownloadFailureEventArgs_Wrap
    {
            ...
            try
            {
                ...
                
                {
                    ...
                    
                    {
                        ...
                        var result = new UnityGameFramework.Runtime.DownloadFailureEventArgs();
                        
                        
                        return Puerts.Utils.GetObjectPtr((int)data, typeof(UnityGameFramework.Runtime.DownloadFailureEventArgs), result);
                    }
            ...
            try
            {
                ...
                
                {
                    ...
                    
                    {
                        ...
                        var Arg0 = argHelper0.Get<GameFramework.Download.DownloadFailureEventArgs>(false);
                        var result = UnityGameFramework.Runtime.DownloadFailureEventArgs.Create(Arg0);
        ...
        private static void M_Clear(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityGameFramework.Runtime.DownloadFailureEventArgs;
        ...
        private static void G_EventId(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                ...
                var result = UnityGameFramework.Runtime.DownloadFailureEventArgs.EventId;
                Puerts.PuertsDLL.ReturnNumber(isolate, info, result);
            }
            catch (Exception e)
            {
