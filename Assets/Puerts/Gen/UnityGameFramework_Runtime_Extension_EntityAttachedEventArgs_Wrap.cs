...
namespace PuertsStaticWrap
{
    public static class UnityGameFramework_Runtime_Extension_EntityAttachedEventArgs_Wrap
    {
            ...
            try
            {
                ...
                
                {
                    ...
                    
                    {
                        ...
                        var result = UnityGameFramework.Runtime.Extension.EntityAttachedEventArgs.Create(Arg0,Arg1,Arg2,Arg3,Arg4);
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void G_ChildEntity(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityGameFramework.Runtime.Extension.EntityAttachedEventArgs;
                var result = obj.ChildEntity;
                Puerts.ResultHelper.Set((int)data, isolate, info, result);
            }
            catch (Exception e)
            {
        ...
        public static Puerts.TypeRegisterInfo GetRegisterInfo()
        {
            return new Puerts.TypeRegisterInfo()
            {
                ...
                Properties = new System.Collections.Generic.Dictionary<string, Puerts.PropertyRegisterInfo>()
                {
                    ...
                    {"ChildEntity", new Puerts.PropertyRegisterInfo(){ IsStatic = false, Getter = G_ChildEntity, Setter = null} },
