namespace PuertsStaticWrap
{
    public static class AutoStaticCodeRegister
    {
        public static void Register(Puerts.JsEnv jsEnv)
        {
            ...
            jsEnv.AddLazyStaticWrapLoader(typeof(UnityGameFramework.Runtime.Extension.CustomEntityLogic), UnityGameFramework_Runtime_Extension_CustomEntityLogic_Wrap.GetRegisterInfo);
            ...
            jsEnv.AddLazyStaticWrapLoader(typeof(UnityGameFramework.Runtime.Extension.CustomUIFormLogic), UnityGameFramework_Runtime_Extension_CustomUIFormLogic_Wrap.GetRegisterInfo);
