...
{
    public static class UnityGameFramework_Runtime_Extension_CustomUIFormLogic_Wrap
    {
            ...
            try
            {
                ...
                
                {
                    ...
                    
                    {
                        ...
                        var result = new UnityGameFramework.Runtime.Extension.CustomUIFormLogic();
                        
                        
                        return Puerts.Utils.GetObjectPtr((int)data, typeof(UnityGameFramework.Runtime.Extension.CustomUIFormLogic), result);
                    }
        ...
        private static void M_OnDeinit(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityGameFramework.Runtime.Extension.CustomUIFormLogic;
