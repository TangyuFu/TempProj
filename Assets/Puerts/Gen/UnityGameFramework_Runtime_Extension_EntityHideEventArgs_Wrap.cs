...
{
    public static class UnityGameFramework_Runtime_Extension_EntityHideEventArgs_Wrap
    {
            ...
            try
            {
                ...
                
                {
                    ...
                    
                    {
                        ...
                        var result = new UnityGameFramework.Runtime.Extension.EntityHideEventArgs();
                        
                        
                        return Puerts.Utils.GetObjectPtr((int)data, typeof(UnityGameFramework.Runtime.Extension.EntityHideEventArgs), result);
                    }
            ...
            try
            {
                ...
                
                {
                    ...
                    
                    {
                        ...
                        var result = UnityGameFramework.Runtime.Extension.EntityHideEventArgs.Create(Arg0,Arg1,Arg2,Arg3);
        ...
        private static void M_Clear(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityGameFramework.Runtime.Extension.EntityHideEventArgs;
        ...
        private static void G_EventId(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                ...
                var result = UnityGameFramework.Runtime.Extension.EntityHideEventArgs.EventId;
                Puerts.PuertsDLL.ReturnNumber(isolate, info, result);
            }
            catch (Exception e)
            {
