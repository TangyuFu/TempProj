    ...
    public static class UnityEngine_UI_Slider_Wrap
    {
        ...
        private static IntPtr Constructor(IntPtr isolate, IntPtr info, int paramLen, long data)
        {
            try
            {
                ...
                Puerts.PuertsDLL.ThrowException(isolate, "invalid arguments to UnityEngine.UI.Slider constructor");
            }
            catch (Exception e)
            {
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void S_fillRect(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.UI.Slider;
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void G_handleRect(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.UI.Slider;
                var result = obj.handleRect;
                Puerts.ResultHelper.Set((int)data, isolate, info, result);
            }
            catch (Exception e)
            {
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void S_handleRect(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.UI.Slider;
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void S_minValue(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.UI.Slider;
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void S_maxValue(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.UI.Slider;
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void G_wholeNumbers(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.UI.Slider;
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void S_wholeNumbers(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.UI.Slider;
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void G_normalizedValue(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.UI.Slider;
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void S_normalizedValue(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.UI.Slider;
        ...
        public static Puerts.TypeRegisterInfo GetRegisterInfo()
        {
            return new Puerts.TypeRegisterInfo()
            {
                ...
                Methods = new System.Collections.Generic.Dictionary<Puerts.MethodKey, Puerts.V8FunctionCallback>()
                {
                    ...
                    { new Puerts.MethodKey {Name = "FindSelectableOnLeft", IsStatic = false}, M_FindSelectableOnLeft },
                    
                    { new Puerts.MethodKey {Name = "FindSelectableOnRight", IsStatic = false}, M_FindSelectableOnRight },
                ...
                Properties = new System.Collections.Generic.Dictionary<string, Puerts.PropertyRegisterInfo>()
                {
                    ...
                    {"fillRect", new Puerts.PropertyRegisterInfo(){ IsStatic = false, Getter = G_fillRect, Setter = S_fillRect} },
                    
                    {"handleRect", new Puerts.PropertyRegisterInfo(){ IsStatic = false, Getter = G_handleRect, Setter = S_handleRect} },
                    
                    {"direction", new Puerts.PropertyRegisterInfo(){ IsStatic = false, Getter = G_direction, Setter = S_direction} },
                    
                    {"minValue", new Puerts.PropertyRegisterInfo(){ IsStatic = false, Getter = G_minValue, Setter = S_minValue} },
                    
                    {"maxValue", new Puerts.PropertyRegisterInfo(){ IsStatic = false, Getter = G_maxValue, Setter = S_maxValue} },
                    
                    {"wholeNumbers", new Puerts.PropertyRegisterInfo(){ IsStatic = false, Getter = G_wholeNumbers, Setter = S_wholeNumbers} },
                    
                    {"value", new Puerts.PropertyRegisterInfo(){ IsStatic = false, Getter = G_value, Setter = S_value} },
                    
                    {"normalizedValue", new Puerts.PropertyRegisterInfo(){ IsStatic = false, Getter = G_normalizedValue, Setter = S_normalizedValue} },
