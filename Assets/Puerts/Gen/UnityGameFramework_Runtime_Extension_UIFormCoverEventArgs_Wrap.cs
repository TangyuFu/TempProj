...
{
    public static class UnityGameFramework_Runtime_Extension_UIFormCoverEventArgs_Wrap
    {
            ...
            try
            {
                ...
                
                {
                    ...
                    
                    {
                        ...
                        var result = new UnityGameFramework.Runtime.Extension.UIFormCoverEventArgs();
                        
                        
                        return Puerts.Utils.GetObjectPtr((int)data, typeof(UnityGameFramework.Runtime.Extension.UIFormCoverEventArgs), result);
                    }
            ...
            try
            {
                ...
                
                {
                    ...
                    
                    {
                        ...
                        var result = UnityGameFramework.Runtime.Extension.UIFormCoverEventArgs.Create(Arg0,Arg1);
        ...
        private static void M_Clear(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityGameFramework.Runtime.Extension.UIFormCoverEventArgs;
        ...
        private static void G_EventId(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                ...
                var result = UnityGameFramework.Runtime.Extension.UIFormCoverEventArgs.EventId;
                Puerts.PuertsDLL.ReturnNumber(isolate, info, result);
            }
            catch (Exception e)
            {
