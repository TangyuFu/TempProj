...
namespace UnityGameFramework.Runtime.Extension
{
    ...
    public class ComponentMark : MonoBehaviour
    {
    ...
    [CustomEditor(typeof(ComponentMark))]
    public class ComponentMarkEditor : UnityEditor.Editor
    {
        ...
        private ComponentMark m_ComponentMark;
        ...
        void OnEnable()
        {
            ...
            m_ComponentMark = target as ComponentMark;
            if (m_ComponentMark == null)
            {
                Log.Error("Invalid component mark.");
                return;
            }

            m_ComponentOptions = m_ComponentMark.GetComponents<Component>().Where(t => t != m_ComponentMark)
        ...
        public override void OnInspectorGUI()
        {
            ...
            {
                m_ComponentMark.Add(m_ComponentOptions[m_AddIndex]);
            }

            m_RemoveIndex = EditorGUILayout.Popup("Remove Component", m_RemoveIndex, m_ComponentOptions);
            if (GUILayout.Button("Remove"))
            {
                m_ComponentMark.Remove(m_ComponentOptions[m_RemoveIndex]);
            }
