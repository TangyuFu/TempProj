...
namespace UnityGameFramework.Runtime.Extension
{
    ...
    public class ProcedureUpdateResources : ProcedureBase
    {
        ...
        protected override void OnEnter(ProcedureOwner procedureOwner)
        {
            ...
            Entry.Event.Subscribe(ResourceUpdateStartEventArgs.EventId, OnResourceUpdateStart);
            Entry.Event.Subscribe(ResourceUpdateChangedEventArgs.EventId, OnResourceUpdateChanged);
            Entry.Event.Subscribe(ResourceUpdateSuccessEventArgs.EventId, OnResourceUpdateSuccess);
            Entry.Event.Subscribe(ResourceUpdateFailureEventArgs.EventId, OnResourceUpdateFailure);
            ...
            if (Application.internetReachability != NetworkReachability.NotReachable)
            {
                ...
                {
                    Mode = 2,
                    Title = Entry.Localization.GetString("UpdateResourceViaCarrierDataNetwork.Title"),
                    Message = Entry.Localization.GetString("UpdateResourceViaCarrierDataNetwork.Message"),
                    ConfirmText = Entry.Localization.GetString("UpdateResourceViaCarrierDataNetwork.UpdateButton"),
                    OnClickConfirm = StartUpdateResources,
                    CancelText = Entry.Localization.GetString("UpdateResourceViaCarrierDataNetwork.QuitButton"),
        ...
        protected override void OnLeave(ProcedureOwner procedureOwner, bool isShutdown)
        {
            ...
            Entry.Event.Unsubscribe(ResourceUpdateStartEventArgs.EventId, OnResourceUpdateStart);
            Entry.Event.Unsubscribe(ResourceUpdateChangedEventArgs.EventId, OnResourceUpdateChanged);
            Entry.Event.Unsubscribe(ResourceUpdateSuccessEventArgs.EventId, OnResourceUpdateSuccess);
            Entry.Event.Unsubscribe(ResourceUpdateFailureEventArgs.EventId, OnResourceUpdateFailure);
        ...
        private void StartUpdateResources(object userData)
        {
            if (m_UpdateResourceForm == null)
            {
                m_UpdateResourceForm = Entry.BuiltinData.UpdateResourceForm;
                m_UpdateResourceForm.gameObject.SetActive(true);
            }

            Log.Info("Start update resources...");
            Entry.Resource.UpdateResources(OnUpdateResourcesComplete);
        }
        ...
        private void RefreshProgress()
        {
            ...
            string descriptionText = Entry.Localization.GetString("UpdateResource.Tips",
                ...
                progressTotal, GetByteLengthString((int) Entry.Download.CurrentSpeed));
            m_UpdateResourceForm.SetDescription(descriptionText);
            m_UpdateResourceForm.SetProgress(progressTotal);
        }
